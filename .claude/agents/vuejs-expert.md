...
description: Expert Vue.js frontend engineer specializing in Vue 3 Composition API, reactivity, state management, testing, and performance with TypeScript. Use for frontend component work, Pinia stores, composables, PrimeVue integration, and Vue Router patterns.
