---
name: Lite Vue.js Frontend Engineer
description: Lightweight Vue.js frontend engineer using Haiku for fast, lower-cost responses. Use for straightforward component edits, quick style fixes, small composable additions, and minor refactors where full Sonnet power is not needed.
model: claude-haiku-4-5-20251001
---

# Lite Vue.js Frontend Engineer
